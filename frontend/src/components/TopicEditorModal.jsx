...
import { makeFlashcard, makeQuizQuestion, normaliseTopic } from "../utils/topicUtils";

export default function TopicEditorModal({ show, topic, onSave, onDelete, onClose }) {
  ...
  function updateQuiz(index, field, value) {
    setDraft((current) => {
      ...
      quizQuestions[index] = { ...quizQuestions[index], [field]: value };
  ...
  function updateQuizOption(questionIndex, optionIndex, value) {
    setDraft((current) => {
      ...
      quizQuestions[questionIndex] = { ...quizQuestions[questionIndex], options };
      return { ...current, quizQuestions };
    });
  }
  ...
  function updateGlossary(index, field, value) {
    setDraft((current) => {
      ...
      glossary[index] = {
        ...(typeof glossary[index] === "object"
          ? glossary[index]
          : { term: glossary[index], definition: "" }),
        [field]: value
      };
  ...
  function handleDelete() {
    const confirmed = window.confirm(`Delete "${draft.topicName}"? This cannot be undone.`);
  ...
  return (
    <div className="revision-modal-backdrop" role="presentation">
      <div className="revision-modal revision-glass-card" role="dialog" aria-modal="true">
        ...
        <div className="revision-modal-body">
          ...
          {activeTab === "notes" && (
            <div className="editor-stack">
              ...
              <button type="button" className="revision-btn revision-btn-secondary" onClick={addNote}>
                + Add Note
              </button>
            </div>
          )}
          ...
          {activeTab === "flashcards" && (
            <div className="editor-stack">
                  ...
                  <div className="two-column">
                    ...
                    <label className="field-block">
                      ...
                      <input
                        ...
                        onChange={(event) => updateFlashcard(index, "tags", event.target.value)}
                      />
                    </label>
                  </div>
              ...
              <button type="button" className="revision-btn revision-btn-secondary" onClick={addFlashcard}>
                + Add Flashcard
              </button>
            </div>
          )}
          ...
          {activeTab === "quiz" && (
            <div className="editor-stack">
                ...
                <div key={question.questionId || index} className="editor-item">
                  <label className="field-block">
                    ...
                    <textarea
                      ...
                      onChange={(event) => updateQuiz(index, "question", event.target.value)}
                    />
                  </label>
                  ...
                  <label className="field-block">
                    ...
                    <input
                      ...
                      onChange={(event) => updateQuiz(index, "answer", event.target.value)}
                    />
                  </label>
                  ...
                  <label className="field-block">
                    ...
                    <textarea
                      ...
                      onChange={(event) => updateQuiz(index, "explanation", event.target.value)}
                    />
                  </label>
              ...
              <button type="button" className="revision-btn revision-btn-secondary" onClick={addQuizQuestion}>
                + Add Quiz Question
              </button>
            </div>
          )}
          ...
          {activeTab === "glossary" && (
            <div className="editor-stack">
                    ...
                    <div className="two-column">
                      <label className="field-block">
                        ...
                        <input
                          ...
                          onChange={(event) => updateGlossary(index, "term", event.target.value)}
                        />
                      </label>
                      ...
                      <label className="field-block">
                        ...
                        <input
                          ...
                          onChange={(event) => updateGlossary(index, "definition", event.target.value)}
                        />
                      </label>
                    </div>
              ...
              <button type="button" className="revision-btn revision-btn-secondary" onClick={addGlossaryTerm}>
                + Add Glossary Term
              </button>
            </div>
          )}
        ...
        <div className="revision-modal-footer">
          <button type="button" className="revision-btn revision-btn-danger" onClick={handleDelete}>
            Delete Topic
          </button>

          <div className="button-row">
            <button type="button" className="revision-btn revision-btn-secondary" onClick={onClose}>
              Cancel
            </button>
            <button type="button" className="revision-btn revision-btn-primary" onClick={handleSave}>
              Save Topic
            </button>
          </div>
        </div>
